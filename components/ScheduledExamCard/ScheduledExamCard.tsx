...
const ScheduledExamCard = ({ exam, timeRemaining, isClickable }) => {
  return (
    ...
    >
      {isClickable ? (
        <Link href={`/available-exams/${exam.examId}/instruction`}>
          <a className="items-center grid grid-cols-3 h-full">
            <div>
              <img
                src={exam.imageUrl}
                alt="exam-image"
              ...
              {timeRemaining ? (
                <div className="flex space-x-2">
                  ...
                  <div>
                    ...
                    <span className="px-1 text-md text-white font-medium">
                      H
                    </span>
                  </div>
                  <div>
                    ...
                    <span className="text-white px-1 text-md font-medium">
                      M
                    </span>
                  </div>
                  <div className="flex items-center">
