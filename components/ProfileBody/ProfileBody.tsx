...
const ProfileBody = async ({ userData }) => {
        ...
        const handleOnClick = () => {
                router.push(`/profile/${userData.clerkId}/scheduled-exams?userId=${userData.id}`)
        ...
        return (
                <div className="  grid justify-center">
                        <div className="grid grid-cols-2 gap-4 w-[600px] p-4 ">
                                <div className="bg-[#13678A] cursor-pointer rounded-lg p-4  place-items-center" onClick={handleOnClick}>
